  ...
  void initState() {
    ...
    if (widget.btntxt == "Write") {
      Fluttertoast.showToast(
          msg: "Click Write button so you can write on"
              " NFC Chip",
...
//                            );
  ...
  void ReadNfc() async {
    ...
    if (message.payload.length > 0) {
      ...
      Fluttertoast.showToast(
          msg: "Tag is empty.", backgroundColor: Colors.yellowAccent);
    }
  ...
  void WriteNfc() async {
    ...
    FlutterNfcReader.write("path_prefix", widget.name).then((response) {
      print("Write Called : " + response.content);
      print("Data : " + widget.name);

      setState(() {
        widget.result = response.content;
      });
