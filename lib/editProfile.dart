            ...
            child: TextField(
              ...
              onChanged: (String value) {
                ...
                if (id == 4) {
                  ...
                  CRUD.whatsapp = "http://www.whatsapp.com/" + value;
                } else if (id == 6) {
                  CRUD.twitter = "http://www.twitter.com/" + value;
                } else if (id == 7) {
                  CRUD.tiktok = "http://www.tiktok.com/" + value;
                } else if (id == 8) {
                  CRUD.soundcloud = "http://www.soundcloud.com/" + value;
                } else if (id == 9) {
                  CRUD.snapchat = "http://www.snapchat.com/" + value;
                } else if (id == 10) {
                  CRUD.paypal = "http://www.paypal.com/" + value;
                } else if (id == 11) {
                  CRUD.music = "http://www.music.com/" + value;
                } else if (id == 12) {
                  CRUD.linkendin = "http://www.linkedin.com/" + value;
                } else if (id == 13) {
                  CRUD.instagram = "http://www.instagram.com/" + value;
                } else if (id == 14) {
                  CRUD.facebook = "http://www.facebook.com/" + value;
                } else if (id == 15) {
                  CRUD.cashapp = "http://www.cashapp.com/" + value;
                } else if (id == 16) {
                  CRUD.venmo = "http://www.venmo.com/" + value;
                }
              },
              cursorColor: Colors.blue,
              decoration: InputDecoration(
